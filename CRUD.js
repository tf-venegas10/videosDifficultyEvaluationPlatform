    ...
    switch (Number(educationlevel)) {
        case 1:
            connection.query('SELECT L.ID FROM (VIDEO_QUALIFICATION Q INNER JOIN LEARNING_RESOURCES L ON Q.VIDEO_ID = L.ID) ' +
                ...
                'WHERE QUALIFICATION_AMOUNT<3 AND QUALIFICATION_AMOUNT>0 AND ( ID BETWEEN 3 AND 22 OR ID BETWEEN 408 AND 425 OR ID BETWEEN 1337 AND 1355 ' +
        ...
        case 4:
            connection.query('SELECT L.ID FROM (VIDEO_QUALIFICATION Q INNER JOIN LEARNING_RESOURCES L ON Q.VIDEO_ID = L.ID) ' +
                'INNER JOIN VIDEO_DURATION D ON D.VIDEO_ID=Q.VIDEO_ID ' +
                'WHERE QUALIFICATION_AMOUNT<3 AND QUALIFICATION_AMOUNT>0 AND ( ID BETWEEN 242 AND 270 OR ID BETWEEN 5116 AND 5140 OR ID BETWEEN 408 AND 425 ' +
        ...
        case 6:
            connection.query('SELECT L.ID FROM (VIDEO_QUALIFICATION Q INNER JOIN LEARNING_RESOURCES L ON Q.VIDEO_ID = L.ID) ' +
                'INNER JOIN VIDEO_DURATION D ON D.VIDEO_ID=Q.VIDEO_ID ' +
                'WHERE QUALIFICATION_AMOUNT<3 AND QUALIFICATION_AMOUNT>0 AND ( ID BETWEEN 242 AND 270 OR ID BETWEEN 306 AND 330 OR ID BETWEEN 5116 AND 5140 ' +
        ...
        default:
            ...
            connection.query('SELECT L.ID FROM (VIDEO_QUALIFICATION Q INNER JOIN LEARNING_RESOURCES L ON Q.VIDEO_ID = L.ID) ' +
                'INNER JOIN VIDEO_DURATION D ON D.VIDEO_ID=Q.VIDEO_ID ' +
                'WHERE QUALIFICATION_AMOUNT<3 AND QUALIFICATION_AMOUNT>0 AND ( ID BETWEEN 149 AND 170 OR ID BETWEEN 306 AND 330 OR ID BETWEEN 5175 AND 5190' +
